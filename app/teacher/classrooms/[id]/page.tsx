...
export default function TeacherRoom(){
  ...
  return <AppShell title="ห้องเรียนสด" back="/teacher/dashboard"><main className="classroom-shell">
    ...
    {configOpen&&<ActivityConfigDialog open={configOpen} onOpenChange={setConfigOpen} value={room.activity} onSave={activity=>manage(store.configureActivity(room.id,activity).then(()=>setNotice("บันทึกการตั้งค่าเกมแล้ว")))}/>}
  </main></AppShell>;
}
