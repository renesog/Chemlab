...
export const LEVELS: PublicLevel[] = [
  ...
  { id: 2, title: "เกลือกับการบูร", mixture: "เกลือ + การบูร", objective: "แยกการบูรออกจากเกลือ โดยเลือกวิธีและเรียงขั้นตอนให้ถูกต้อง", difficulty: 2, equipment: [{id:"sublime",label:"เตรียมชุดระเหิด"},{id:"gentle-heat",label:"ให้ความร้อนอย่างระมัดระวัง"},{id:"collect-camphor",label:"เก็บผลึกการบูรที่ควบแน่น"},{id:"add-water",label:"เติมน้ำให้เกลือละลาย"},{id:"stir",label:"คนให้เกลือละลาย"},{id:"filter-camphor",label:"กรองแยกการบูร"},{id:"sieve",label:"ร่อนด้วยตะแกรง"}] },
  { id: 3, title: "น้ำตาลซ่อนในเทียนไข", mixture: "น้ำตาล + เทียนไข (พาราฟิน)", objective: "แยกเทียนไขและนำน้ำตาลกลับคืนมาให้ได้ทั้งสองส่วน", difficulty: 3, equipment: [{id:"add-water",label:"เติมน้ำสะอาดหรือน้ำอุ่น"},{id:"stir",label:"คนให้น้ำตาลละลายในน้ำ"},{id:"cool-wax",label:"ปล่อยให้เทียนไขเย็นและแข็งตัว"},{id:"remove-wax",label:"ตักเทียนไขที่ลอยอยู่ออก"},{id:"evaporate",label:"ระเหยน้ำอย่างอ่อนเพื่อเก็บน้ำตาล"},{id:"magnet",label:"ใช้แม่เหล็ก"},{id:"sieve",label:"ร่อนด้วยตะแกรง"}] },
  ...
  { id: 5, title: "น้ำใสจากทราย", mixture: "ทราย + น้ำ", objective: "แยกทรายออกและเก็บน้ำใสไว้ในภาชนะ", difficulty: 4, equipment: [{id:"paper",label:"ใส่กระดาษกรองในกรวย"},{id:"receiver",label:"วางภาชนะรองรับ"},{id:"pour",label:"เทส่วนผสมผ่านกรวย"},{id:"heat",label:"ให้ความร้อน"}] },
